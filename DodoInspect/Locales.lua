...
ns.Locales = {
    ...
    en = {
        ...
        lootOwnedEquipped  = "Equipped",
        lootOwnedBags      = "Bags",
        lootOwnedBank      = "Bank",
        lootNoDrops        = "Nothing here for this specialization",
        lootNoSpec         = "Specialization unknown",
        lootCeiling        = "cap %d",
        lootClass          = "Class",
        lootSpec           = "Specialization",
        lootUnranked       = "no stat priority",
    ...
    cn = {
        ...
        lootNoData     = "本季没有掉落数据",
        lootOwnedEquipped  = "已装备",
        lootOwnedBags      = "背包",
        lootOwnedBank      = "银行",
        lootNoDrops        = "这里没有本专精能用的装备",
        lootNoSpec         = "读不到专精",
        lootCeiling        = "上限 %d",
        lootClass          = "职业",
        lootSpec           = "专精",
    ...
    fr = {
        ...
        lootOwnedEquipped  = "Equipe",
        lootOwnedBags      = "Sacs",
        lootOwnedBank      = "Banque",
        lootNoDrops        = "Rien ici pour cette specialisation",
        lootNoSpec         = "Specialisation inconnue",
        lootCeiling        = "max %d",
        lootClass          = "Classe",
        lootSpec           = "Specialisation",
        lootUnranked       = "pas de priorite de stats",
    ...
    es = {
        ...
        lootOwnedEquipped  = "Equipado",
        lootOwnedBags      = "Bolsas",
        lootOwnedBank      = "Banco",
        lootNoDrops        = "Nada aqui para esta especializacion",
        lootNoSpec         = "Especializacion desconocida",
        lootCeiling        = "max %d",
        lootClass          = "Clase",
        lootSpec           = "Especializacion",
        lootUnranked       = "sin prioridad de stats",
