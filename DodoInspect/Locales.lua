...
ns.Locales = {
    ...
    en = {
        ...
        gearNoTrinketSim = "No simulation data for this spec - order below is not a ranking",
    ...
    cn = {
        ...
        gearNoSpec = "专精未知",
        gearNoTrinketSim = "本专精暂无模拟数据,下方顺序不代表强弱",
        gearTwoHand = "双手",
        gearOneHand = "单手",
    ...
    fr = {
        ...
        gearNoTrinketSim = "Pas de donnees de simulation pour cette spe - l'ordre ci-dessous n'est pas un classement",
    ...
    es = {
        ...
        gearNoTrinketSim = "Sin datos de simulacion para esta espec - el orden de abajo no es un ranking",
