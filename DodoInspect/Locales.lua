...
ns.Locales = {
    ...
    en = {
        ...
        priDisclaimer = "Fixed general gearing reference; the order does not adapt to your current stats. Item level and primary stat usually come first; tank priorities assume survival and healer priorities assume healing. Sim your character for final choices.",
        priBuild      = "Build: %s",
    },
    ...
    cn = {
        ...
        priDisclaimer = "这是固定优先级，不根据你当前绿字调整，仅供通用配装参考。通常先看装等和主属性；坦克按生存、治疗按治疗量排序，最终请模拟自己的角色。",
        priBuild      = "构建: %s",
    },
    ...
    fr = {
        ...
        priDisclaimer = "Reference generale fixe; l'ordre ne s'adapte pas a vos stats actuelles. Le niveau d'objet et la statistique principale priment souvent; tanks = survie, soigneurs = soins. Simulez votre personnage.",
        priBuild      = "Build : %s",
    },
    ...
    es = {
        ...
        priDisclaimer = "Referencia general fija; el orden no se adapta a tus stats actuales. El nivel de objeto y la estadistica principal suelen primar; tanques = supervivencia, sanadores = sanacion. Simula tu personaje.",
        priBuild      = "Build: %s",
    },
}
