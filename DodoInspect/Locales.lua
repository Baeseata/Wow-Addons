...
ns.Locales = {
    ...
    en = {
        ...
        priAfterRating = "At/above ~%d %s rating",
        priAfterPercent = "At/above ~%d%% %s",
        priAfterRatingPercent = "At/above ~%d %s rating (~%d-%d%%)",
        priGoalRating = "%s target ~%d rating",
    ...
    cn = {
        ...
        priSame    = "团本与大米相同",
        priSoftcap = "%s软上限~%d%%",
        priAfterRating = "约%d %s评级后",
        priAfterPercent = "约%d%% %s后",
        priAfterRatingPercent = "约%d %s评级后（约%d-%d%%）",
        priGoalRating = "%s目标约%d评级",
    ...
    fr = {
        ...
        priAfterRating = "A partir d'environ %d score de %s",
        priAfterPercent = "A partir d'environ %d%% de %s",
        priAfterRatingPercent = "A partir d'environ %d score de %s (~%d-%d%%)",
        priGoalRating = "Objectif %s : ~%d score",
    ...
    es = {
        ...
        priSoftcap = "%s tope ~%d%%",
        priAfterRating = "Desde ~%d de indice de %s",
        priAfterPercent = "Desde ~%d%% de %s",
        priAfterRatingPercent = "Desde ~%d de indice de %s (~%d-%d%%)",
        priGoalRating = "Objetivo de %s: ~%d de indice",
