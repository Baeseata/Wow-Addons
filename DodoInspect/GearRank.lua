...
-- spec's stat order, and nothing else. It does not know about item
-- level, tier set bonuses, on-item effects, weapon damage or trinket
-- procs. Those are surfaced as flags next to a row, never folded into
-- the score.
